...
4. 编译systemc
    ...
    * 运行configure(能根据系统的环境设置一下参数，用于编译)  
     ...
     ![](https://raw.githubusercontent.com/ES201614353201/ES2016_14353201/master/1.PNG)
    * 编译  
     `sudo make install`
    * 记录当前的工作路径  
     `sudo pwd`  
    ![](https://raw.githubusercontent.com/ES201614353201/ES2016_14353201/master/2.PNG)
 5. 编译dol
    * 进入刚刚dol的文件夹  
     `cd ../dol`
    * 修改build_zip.xml文件  
    ...
    * 运行第一个例子  
    ...
    ![](https://raw.githubusercontent.com/ES201614353201/ES2016_14353201/master/3.PNG)
